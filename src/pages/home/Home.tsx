      ...
      <main className="mt-4">
        <div className="container mx-auto px-5 space-y-4">
          ...
          <div className="my-10 space-y-4">
            ...
            <div className="grid grid-cols-[repeat(3,1fr)] max-laptop-l:grid-rows-[repeat(3,1fr)] gap-y-[10px] gap-x-[10px] laptop-l:grid-cols-[repeat(4,1fr)] laptop-l:grid-rows-[repeat(4,1fr)]">
