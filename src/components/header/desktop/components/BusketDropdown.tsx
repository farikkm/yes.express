...
const BusketDropdown = () => {
  ...
  return (
    <DropdownMenuOverlay>
      ...
      <DropdownMenuContent align="end" className="p-2 rounded-3xl">
        <DropdownMenuLabel className="w-[400px] px-2 py-3">
        ...
        <button className="mt-4 flex items-center justify-between w-full p-3 bg-green-400 rounded-3xl">
          ...
          <span className="text-2xl text-black font-bold">55,000 sum</span>
        </button>
      </DropdownMenuContent>
    </DropdownMenuOverlay>
  );
